Pod::Spec.new do |s|
	...
	s.homepage = "https://github.com/mpmobile/ios-MIACore"
	s.license = ''
	s.author = { "William Izzo" => "william.izzo.mail@makeitapp.com" }
	s.source = { :git => "https://github.com/mpmobile/ios-MIACore.git", :tag => s.version }
	s.platform = :ios, '8.0'
    s.requires_arc = true
